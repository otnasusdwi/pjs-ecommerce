                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="mobile" placeholder="Type Password here" maxlength="16" oninput="validateNumberInput(this)" name="mobile" value="<?= $users->mobile ?>">
                                        </div>
                                    <?php } ?>
                                </div>
                                <div class="form-group row">
