                                ...
                                <form class="form-horizontal " id="shiprocket_order_parcel_form" action="<?= base_url('admin/orders/create_shiprocket_order/'); ?>" method="POST">
                                    ...
                                    <div class="card-body pad">
                                        ...
                                        <div class="mt-1 p-2 bg-danger text-white rounded">
                                            <p><b>Note:</b> Make your pickup location associated with the order is verified from <a href="https://app.shiprocket.in/company-pickup-location?redirect_url=" target="_blank" class="text-decoration-underline color-white"> Shiprocket Dashboard </a> and then in <a href="<?php base_url('admin/Pickup_location/manage-pickup-locations'); ?>" target="_blank" class="text-decoration-underline color-white"> admin panel </a>. If it is not verified you will not be able to generate AWB later on.</p>
                                        </div>
