                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            ...
                                                            <div class=" <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                ...
                                                                <?php if (isset($settings['city_wise_deliverability']) && $settings['city_wise_deliverability'] == 1) { ?>
                                                                    <div class="mt-2">
                                                                        <select class="form-control city_list" name="city[]" id="city_list" multiple onload="multiselect()" <?= (isset($product_details[0]['deliverable_type']) &&  ($product_details[0]['deliverable_type'] == INCLUDED || $product_details[0]['deliverable_type'] == EXCLUDED))  ? "" : "" ?>>
                                                                            <?php
