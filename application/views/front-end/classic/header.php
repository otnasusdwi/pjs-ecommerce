                    ...
                    <?php if ($this->ion_auth->logged_in()) { ?>
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg">
                                ...
                                <a href="<?= base_url('my-account/refer_and_earn') ?>" class="dropdown-item refer_and_earn"><i class="fa fa-money-bill mr-2 text-primary link-color"></i><?= !empty($this->lang->line('Refer And Earn')) ? $this->lang->line('Refer And Earn') : 'Refer And Earn' ?></a>
