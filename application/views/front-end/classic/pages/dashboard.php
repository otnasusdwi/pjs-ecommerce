            ...
            <div class="col-md-8 col-12 row">
                ...
                <div class='col-md-3 card text-center border-0 mr-3 mb-3'>
                    <a href='<?= base_url('my-account/delete_user') ?>' class="link-color">
                        <div class='card-header bg-transparent'>
                            <?= !empty($this->lang->line('Delete_account')) ? $this->lang->line('Delete Account') : 'Delete Account' ?>
                        </div>
                        <div class='card-body'>
                ...
                <div class='col-md-3 card text-center border-0 mr-3 mb-3'>
                    <a href='<?= base_url('my-account/tickets') ?>' class="link-color">
                        <div class='card-header bg-transparent'>
                            <?= !empty($this->lang->line('customer_support')) ? $this->lang->line('Customer support') : 'Customer support' ?>
                        </div>
                        <div class='card-body'>
