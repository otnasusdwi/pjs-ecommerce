                    ...
                    <form action="<?= base_url('my-account/add-address') ?>" method="POST" id="add-address-form" class="mt-4 p-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="number" class="form-control" id="mobile_number" name="mobile" placeholder="Mobile Number" />
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                ...
                                <input type="number" class="form-control" id="alternate_mobile" name="alternate_mobile" placeholder="Alternate Mobile Number" />
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
