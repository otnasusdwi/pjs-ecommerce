        ...
        <div class="row">
            ...
            <div class="col-md-9 padding-16-30">
                ...
                <div class="text-center mt-4">
                    ...
                    <button class="my-2 btn btn-primary btn-sm copy-button" onclick="copyText()">Tap to copy</button>
                    <h6 class="text-body-secondary mt-2">Invite your friends to join and get the reward as soon as your friend places his first order</h6>
                </div>
            </div>
        </div>
    </section>
