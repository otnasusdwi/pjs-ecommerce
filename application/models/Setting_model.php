...
class Setting_model extends CI_Model
{
    ...
    public function update_payment_method($post)
    {
        ...
        $payment_data = array();
        $payment_data['xendit_payment_method'] = isset($post['xendit_payment_method']) ? '1' : '0';
        $payment_data['xendit_secret_key_test'] = isset($post['xendit_secret_key_test']) && !empty($post['xendit_secret_key_test']) ? $post['xendit_secret_key_test'] : '';
        $payment_data['xendit_secret_key_live'] = isset($post['xendit_secret_key_live']) && !empty($post['xendit_secret_key_live']) ? $post['xendit_secret_key_live'] : '';
