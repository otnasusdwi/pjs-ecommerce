...
class Cart extends CI_Controller
{
    ...
    public function place_order()
    {
        ...
        */
            ...
            if (isset($time_slot_config['is_time_slots_enabled']) && ($time_slot_config['is_time_slots_enabled'] == 1 || $time_slot_config['is_time_slots_enabled'] == '1') && $_POST['product_type'] != 'digital_product') {
