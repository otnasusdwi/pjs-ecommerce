...
function is_product_delivarable($type, $type_id, $product_id)
{
    ...
    if (!empty($zipcode_id) && $zipcode_id != 0) {
        ...
        $ci->db->group_Start();
        // if ($type == 'city') {
        //     $where = "(((deliverable_type = '2' AND FIND_IN_SET('" . $city_id . "', deliverable_citys))OR deliverable_type = '1') OR (deliverable_type = '3' AND NOT FIND_IN_SET('" . $city_id . "',deliverable_citys))) ";
        // } else {
